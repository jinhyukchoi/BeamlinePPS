...
/* Generated from ../O.Common/XF_PPS.dbd */
...
int XF_PPS_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/epics/iocs/XF_PPS";
...
/* XF_PPS_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"XF_PPS_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(XF_PPS_registerRecordDeviceDriver(*iocshPpdbbase));
}
